...
model.nodeDataArray =
    [
        ...
        { key: "15", name: "Location", group: "Contexts", active: false, isParentPresent: true, isExpanded: true, firstChild: false },
        ...
        { key: "27", name: "Natural disaster", group: "Contexts", active: true, isParentPresent: true, isExpanded: true, firstChild: false },
        { key: "28", name: "Domestic disaster", group: "Contexts", active: false, isParentPresent: true, isExpanded: true, firstChild: false },
        ...
        { key: "105", name: "Alert", group: "Features", active: true, isParentPresent: true, isExpanded: true },
        { key: "106", name: "Risk informations", group: "Features", active: true, isParentPresent: true, isExpanded: true },
        { key: "107", name: "Description", group: "Features", active: true, isParentPresent: true, isExpanded: true },
        { key: "108", name: "Type", group: "Features", active: true,isParentPresent: true, isExpanded: true },
        ...
        { key: "111", name: "Severity", group: "Features", active: true, isParentPresent: true, isExpanded: true },
        { key: "112", name: "Location", group: "Features", active: true,isParentPresent: true, isExpanded: true },
        ...
        { key: "128", name: "Generic", group: "Features", active: false,isParentPresent: true, isExpanded: true },
...
model.linkDataArray =
    [
        ...
        { from: "27", to: "40", group: "Contexts", category: "OR" },
        { from: "27", to: "41", group: "Contexts", category: "OR" },
        { from: "27", to: "42", group: "Contexts", category: "OR" },
        { from: "28", to: "43", group: "Contexts", category: "OR" },
        { from: "28", to: "44", group: "Contexts", category: "OR" },
        ...
        { from: "126", to: "127", group: "Features", category: "OR" },
        { from: "126", to: "128", group: "Features", category: "OR" },
        { from: "127", to: "129", group: "Features", category: "XOR" },
        { from: "127", to: "130", group: "Features", category: "XOR" },
        { from: "127", to: "131", group: "Features", category: "XOR" },
